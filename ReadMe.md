...
# A1) Mythril, SoA of Symbolic Execution, give better results than bots?

Overall bot finds: 0 high, 6 medium (all valid)\
Overall Mythril finds: 39 high (37 IAB), 3 medium, 41 low \
Mythril valid finds: 1 high (2.5%), 0 medium, 1 low(2.4%)\

With budget of 24h, Mythril is as effective as bot (1h).\




# B1) Mythril, SoA of Symbolic Execution, give better results than wardens?
Overall wardens finds: 11 high, 32 medium (all valid)\
Overall Mythril finds: 39 high (37 IAB), 3 medium, 41 low \
Mythril valid finds: 1 high (2.5%), 0 medium, 1 low(2.4%)\

With budget of 24h, Mythril is less effective of wardens (>7 days).\
